 ...
 */
package Exercicios.Conteudo2.Exercicio10;
...
public class Pessoas extends javax.swing.JFrame {
    ...
    String vetorProduto[] = new String[10];
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
        ...
        if (posicao < 10){ // Verifica se os vetores estão cheios
            ...
            vetorId[posicao] = 550 + list1.getItemCount();

            list2.add(vetorId[posicao]+"");// adiciona em LISTAR as informações
